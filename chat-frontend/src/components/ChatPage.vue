                ...
                <div class="card">
                    <div class="card-header msg_head">
                        <div class="d-flex bd-highlight">
                            ...
                            <div class="user_info">
                                <span>Chat with {{ sendToUsername }}</span>
                                <p>1767 Messages</p>
                            </div>
                            <div class="video_cam">
                    ...
                    <div class="card-body msg_card_body" ref="msgContainer">
                        <div v-for="(message, index) in activeChatMessages" :key="index">
                            <div class="d-flex justify-content-start mb-4" v-if="message.username !== username">
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            ...mapGetters(['activeChatMessages', 'username', 'sendToUsername'])
        },
        mounted() {
